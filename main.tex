...
% Inserting Dockerfile 
\begin{figure}[h]
\centering
\includegraphics[scale=0.25]{Dockerfile.png}
...
% Inserting  K8s deployment file
\begin{figure}[h]
\centering
\includegraphics[scale=0.25]{k8s_Deployment.png}
...
% Inserting  Ansible playbook
\begin{figure}[h]
\centering
\includegraphics[scale=0.3]{Ansible_playbook.png}
...
% Extensive Monitoring via Prometheus & Grafana
\begin{figure}[h]
\centering
\includegraphics[scale=0.6]{Prometheus-Grafana.png}
...
\bibitem{Boney96} https://www.github.com/YG3A5D, \textbf{\emph{https://www.github.com/YG3A5D/MLOps\_Project}}
 
\bibitem{MG}  Christian Schenk, \textbf{\emph{LaTeX Compiler https://miktex.org/download}}
 
\bibitem{Numpy} Sebastian Berg,Ralf Gommers, Charles Harris, Stephan Hoyer, Melissa Weber  Mendonça,Inessa Pawson, Matti Picus, Stéfan van der Walt, Eric Wieser, \textbf{ \emph{https://numpy.org/docs}} 

\bibitem{Pandas} Pandas Open-source Community, \textbf{ \emph{https://pandas.pydata.org/docs}} 
 
\bibitem{Kubernetes} Cloud Native Computing Foundation, \textbf{ \emph{https://kubernetes.io/docs}} 
 
\bibitem{Docker} Solomon Hykes, Docker Inc., \textbf{\emph{https://www.docker.com/docs}}
 
 \bibitem{Jenkins} Kohsuke Kawaguchi, Jenkins Open-source community., \textbf{\emph{https://www.jenkins.io/docs}}

 \bibitem{Ansible} Michael DeHaan, Open-source community, \textbf{\emph{https://www.ansible.com/docs}}
